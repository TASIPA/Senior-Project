...
class RestaurantAdapter(private val rssObject: MutableList<Restaurants>, private val mContext: Context, private val listener: onItemClickListener): RecyclerView.Adapter<RestaurantAdapter.FeedViewHolders>() {
    ...
    override fun onBindViewHolder(holder: FeedViewHolders, position: Int) {
        ...
        holder.txtTitle2.text = filteredData[position].Rating.toString()
    ...
    inner class FeedViewHolders(itemView: View):RecyclerView.ViewHolder(itemView),View.OnClickListener
    {
        ...
        var txtTitle2: TextView = itemView.findViewById(R.id.vv12)
